...
namespace MZ_MJ_Proyecto1.Controllers
{
    public class PagoesController : Controller
    {
        ...
        public PagoesController(MZ_MJ_Proyecto1Context context)
        {
            _context = context;
        }
        ...
        {
            var mZ_MJ_Proyecto1Context = _context.Pago.Include(p => p.Habitacion);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MZ_MJ_Proyecto1Context.Pago'  is null.");
            }
            var pago = await _context.Pago.FindAsync(id);
            if (pago != null)
            {
